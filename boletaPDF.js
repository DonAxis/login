// Función para generar PDF de la boleta actual (materias visibles en pantalla)
async function generarPDFBoletaActual() {
  ...
  try {
    ...
    // Obtener materias actuales (las que están en pantalla)
...
console.log('Función generarPDFBoletaActual cargada');